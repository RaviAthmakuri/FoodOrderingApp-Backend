...
public class OrderControllerTest {
    ...
    public void shouldGetPlacedOrderDetails() throws Exception {
        ...
        assertEquals(customerOrderResponse.getOrders().get(0).getAddress().getState().getId().toString(), orderEntity.getAddress().getStateEntity().getUuid());
    ...
    private OrdersEntity getOrderEntity(final CustomerEntity customerEntity) {
        ...
        return new OrdersEntity(orderId, 200.50, couponEntity, 10.0,
               new Timestamp(orderDate.getTime()), paymentEntity, customerEntity, addressEntity, restaurantEntity);
    }
