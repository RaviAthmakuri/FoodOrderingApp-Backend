...
public class CategoryDao {
    ...
    public List<CategoryEntity> getAllCategoriesByName() {
        try {
            List<CategoryEntity> categoryEntities = entityManager.createNamedQuery("getAllCategoriesByName",CategoryEntity.class).getResultList();
